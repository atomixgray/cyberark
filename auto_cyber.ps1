#Install Options
#This repository contains a folder named psPAS.  The folder needs to be copied to one of your PowerShell Module Directories.
...
$teamname1 = Read-Host " Enter User's Team Name: Server Team"
